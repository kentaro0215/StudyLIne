# -*- encoding: utf-8 -*-
# stub: meta-tags 2.19.0 ruby lib

Gem::Specification.new do |s|
  s.name = "meta-tags".freeze
  s.version = "2.19.0".freeze
  ...
  s.add_runtime_dependency(%q<actionpack>.freeze, [">= 3.2.0".freeze, "< 7.2".freeze])
  s.add_development_dependency(%q<railties>.freeze, [">= 3.2.0".freeze, "< 7.2".freeze])
  ...
  s.add_development_dependency(%q<appraisal>.freeze, ["~> 2.5.0".freeze])
  s.add_development_dependency(%q<simplecov>.freeze, ["~> 0.22.0".freeze])
  s.add_development_dependency(%q<standard>.freeze, ["~> 1.29".freeze])
  s.add_development_dependency(%q<rubocop-rails>.freeze, ["~> 2.20.2".freeze])
  s.add_development_dependency(%q<rubocop-rake>.freeze, ["~> 0.6.0".freeze])
  s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 2.23.0".freeze])
